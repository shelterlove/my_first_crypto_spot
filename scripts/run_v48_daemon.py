#!/usr/bin/env python3
"""Run the V4.8 deployment loop as a long-lived process.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-order-usdt", default="25")
    parser.add_argument("--log-file", default="logs/v48_daemon.log")
