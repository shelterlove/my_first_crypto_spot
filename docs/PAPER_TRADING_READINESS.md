...
`v2_10` is the current best research candidate. It builds on the narrow
...
Run: `results/v1_eval_upgrade/20260529_181232_v2_10`

Result: score `0.6508`, BULL median excess `-16.34%`, BULL win rate `35.05%`,
