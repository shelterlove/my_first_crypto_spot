...
from .strategy_core import position_book as position_book
...
def _build_execution_transform_actions(
    ...
    return position_book.build_rebalance_actions(
        strategy=strategy,
...
def _record_execution_transform_audit(
    ...
    return position_book.audit_rows(
        strategy=strategy,
        timestamp=timestamp,
        decision_portfolio=decision_portfolio,
        portfolio=portfolio,
...
def _build_execution_transform_liquidation_actions(
    ...
    return position_book.build_liquidation_actions(
        strategy=strategy,
        portfolio=portfolio,
        mark_prices=mark_prices,
        fee_rate=fee_rate,
...
def _build_execution_transform_intraday_shock_actions(
    ...
    return position_book.build_intraday_shock_actions(
        strategy=strategy,
        portfolio=portfolio,
