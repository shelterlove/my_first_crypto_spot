...
class SignalEngine:
    def build_signals(self, owner, context: StrategyContext, regime: StrategyRegime, episode: dict) -> StrategySignals:
    ...
    @staticmethod
    def accumulation_signal(episode: dict, signals: StrategySignals) -> bool:
    ...
    @staticmethod
    def starter_signal(context: StrategyContext, regime: StrategyRegime) -> bool:
        return bool(
    ...
    @staticmethod
    def value_recovery(owner, context: StrategyContext, regime: StrategyRegime) -> bool:
    ...
    @staticmethod
    def trend_continuation(owner, context: StrategyContext, regime: StrategyRegime) -> bool:
        latest = context.latest
        price = context.price
    ...
    def late_trend_continuation_risk(self, owner, context: StrategyContext, regime: StrategyRegime) -> bool:
        latest = context.latest
    ...
    @staticmethod
    def distribution_exhaustion(owner, context: StrategyContext, regime: StrategyRegime) -> bool:
        latest = context.latest
    ...
    def recovery_signal(self, owner, context: StrategyContext, regime: StrategyRegime) -> bool:
    ...
    def strong_recovery_signal(self, owner, context: StrategyContext, regime: StrategyRegime) -> bool:
        return bool(
    ...
    @staticmethod
    def recovery_quality_ok(owner, context: StrategyContext, regime: StrategyRegime) -> bool:
        latest = context.latest
        atr_rank = owner._value(latest, "atr_pct_rank", 0.5)
