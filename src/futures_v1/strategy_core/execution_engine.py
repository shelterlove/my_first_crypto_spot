"""V1 execution-layer composition.

This module owns the clean V1 execution boundary:
...
class ExecutionEngine:
    ...
    def main_transform(self, *, owner: ExecutionOwner, symbol: str, raw_pct: float) -> tuple[float, str]:
