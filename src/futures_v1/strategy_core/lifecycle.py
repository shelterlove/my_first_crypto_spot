"""Lifecycle shadow boundary for V1."""
...
class LifecycleEngine:
    def record_lifecycle_state_shadow(
        ...
        lifecycle = owner._lifecycle_policy.build_view(
            context=context,
            regime=regime,
            episode=episode,
            signals=signals,
    ...
    @staticmethod
    def lifecycle_source_quantities(owner, context: StrategyContext) -> dict[str, float]:
