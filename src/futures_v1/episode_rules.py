...
from .strategy_types import StrategyContext, StrategyRegime, StrategySizing


class StrategyEpisodeMixin:
    def _update_episode(self, context: StrategyContext, regime: StrategyRegime) -> dict:
    ...
    def _start_episode(self, context: StrategyContext, sizing: StrategySizing) -> None:
        symbol = context.symbol
        setup = sizing.setup
        ...
        self._diag["core_episode_started_count"] += 1

    def _append_episode_sell_leg(self, context: StrategyContext, episode: dict, sizing: StrategySizing) -> None:
        sold_pct = sizing.quantity * context.price / context.total_value if context.total_value > 0.0 else 0.0
        post_sell_pct = max(0.0, context.current_pct - sold_pct)
    ...
    def _close_episode(self, symbol: str, reason: str) -> None:
        ...
        self._diag["core_episode_closed_count"] += 1
