...
from .v42_types import V42Context, V42Lifecycle, V42Regime, V42RiskAssessment, V42RiskGate


class V42RiskMixin:
    def _build_lifecycle(self, context: V42Context, regime: V42Regime, episode: dict) -> V42Lifecycle:
    ...
    @staticmethod
    def _lifecycle_reason(phase: str, regime: V42Regime) -> str:
        if phase == "NORMAL":
            return "normal"
        if phase == "BEAR":
            return "bear_regime"
    ...
    def _build_risk_gate(self, context: V42Context, regime: V42Regime, lifecycle: V42Lifecycle) -> V42RiskGate:
