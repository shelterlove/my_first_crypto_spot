...
from .v42_types import V42Context, V42DecisionPlan, V42Regime, V42Signals, V42Sizing


@dataclass(frozen=True)
class V45LifecycleView:
    state: str
    reason: str
    low_location: bool
...
class V45LifecyclePolicy:
    ...
    def low_location(self, *, context: V42Context, regime: V42Regime) -> bool:
    ...
    @staticmethod
    def sell_allowed_sources(*, context: V42Context, sizing: V42Sizing) -> str:
        if sizing.side != "sell":
            return ""
    ...
    def risk_ceiling(self, *, context: V42Context, regime: V42Regime, lifecycle_state: str) -> float:
    ...
    @classmethod
    def _series_float(cls, context: V42Context, key: str, default: float | None = None) -> float | None:
        try:
