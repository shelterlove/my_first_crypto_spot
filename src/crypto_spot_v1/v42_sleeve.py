...
from .v42_types import V42Context, V42Regime, V42Signals, V42SleevePlan, V42TargetPlan


class V42SleeveMixin:
    ...
    @staticmethod
    def _select_primary_sleeve(sleeve_plans: tuple[V42SleevePlan, ...]) -> V42SleevePlan:
    ...
    def _buy_setup(self, context: V42Context, regime: V42Regime, episode: dict, signals: V42Signals) -> str:
    ...
    def _bear_base_accumulate_needed(self, context: V42Context, regime: V42Regime, episode: dict, signals: V42Signals) -> bool:
        return bool(
